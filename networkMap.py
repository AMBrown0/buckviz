...
df = pd.DataFrame({'source':['Borris', 'Borris','Diana','Diana','Chloe','Chloe','Chloe','Adam',
                             'Adam','Adam','Adam','Harry','Harry','Harry'], 
                   'target':['Harry','Adam','Harry','Adam','Fiona','Adam','Ezzy','Diana','Borris','Chloe','Ezzy','Ezzy','Borris','Diana']})
# Build your graph
